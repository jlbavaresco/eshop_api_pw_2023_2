...
const addProdutoDB = async (body) => {
    try {
        ...
        VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING codigo, nome, descricao, 
        quantidade_estoque, ativo, valor, 
        to_char(data_cadastro,'YYYY-MM-DD') as data_cadastro, categoria`, [nome, descricao, quantidade_estoque,
            ativo, valor,
            data_cadastro, categoria]);
...
const updateProdutoDB = async (body) => {
    try {
        ...
        data_cadastro = $7, categoria = $8
         WHERE codigo = $1 returning codigo, nome, descricao, 
         quantidade_estoque, ativo, valor, 
         to_char(data_cadastro,'YYYY-MM-DD') as data_cadastro, categoria`, [codigo, nome, descricao, quantidade_estoque,
            ativo, valor,
            data_cadastro, categoria]);
